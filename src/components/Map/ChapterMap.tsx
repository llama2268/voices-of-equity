                        ...
                        <div className="p-3 min-w-[200px] text-center">
                            <div className="flex items-center justify-center mb-2 gap-2">
                                ...
                                {popupInfo.logo ? (
                                    ...
                                    <div className="p-2 bg-[#2A8D87]/10 rounded-full">
                                        <svg className="w-4 h-4 text-[#2A8D87]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <Link
                                ...
                                className="inline-flex items-center justify-center text-xs bg-[#2A8D87] text-white px-4 py-1.5 rounded-full hover:bg-[#1F6B66] transition-colors font-medium shadow-sm !min-h-0 !min-w-0"
                            >
                                View Chapter
                            </Link>
                        </div>
