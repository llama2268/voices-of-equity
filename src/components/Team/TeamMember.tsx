...
const TeamMember = ({
  ...
  return (
    <div
      ...
      className="flex h-full w-full max-w-[16rem] cursor-pointer flex-col items-center space-y-4 rounded-lg bg-white/60 p-6 shadow-md backdrop-blur-sm transition-all duration-300 hover:shadow-lg gap-x-10"
    >
