...
export default function UPennChapterPage() {
  const chapter = placeholderChapters.upenn;
  return (
    <PageLayout>
      {/* Hero Section */}
      ...
      {/* Introduction */}
      <Section title="About Our Chapter" subtitle="Leading Change at UPenn">
      ...
      {/* Key Initiatives */}
      <Section variant="alternate" title="Our Initiatives" subtitle="Making Impact in Philadelphia">
                <div className="max-w-4xl mx-auto">
