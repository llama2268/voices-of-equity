...
export const resourcesPage = {
  main: {
    ...
    content: {
      documentary: {
        title: "VoE Documentary | B.A.D.",
        eyebrow: "Educational Content",
        description:
          "Watch our new docuseries exploring addiction and health care through an equity-based lens, created by Alexander Park and Sid Martis.",
        episodes: [
          {
            episode: 1,
            title: "Episode 1: B.A.D.",
            description:
              "The opening episode of our documentary series on addiction, health care, and equity.",
            videoId: "xT4J0kljvu0",
            status: "released",
          },
          {
          ...
          },
          {
            ...
            title: "Episode 5",
            description:
              "Episode 5 of our documentary series on addiction, health care, and equity.",
            videoId: "I7J2IrFM31U",
            status: "released",
          },
          {
            ...
            title: "Episode 6",
            description:
              "Episode 6 of our documentary series on addiction, health care, and equity.",
            videoId: "F5-GiRqlzGA",
            status: "released",
          },
          {
            ...
            title: "Episode 7",
            description:
              "Episode 7 of our documentary series on addiction, health care, and equity.",
            videoId: "mi1hZTdchKs",
            status: "released",
          },
      ...
      videos: [
        {
          ...
          description:
            "An introduction to health equity and why it matters in today's healthcare landscape.",
        },
        {
          videoId: "Mfc-dMTQHbQ",
          title: "Social Determinants of Health Explained",
          description:
            "The social determinants of health—economic stability, education, neighborhood environment, and more—shape our well-being.",
        },
        {
          videoId: "Ohyu3BhhqqA",
          title: "The Science and Stigma Behind Addiction",
          description:
            "Explore the biological mechanisms of addiction and the social stigmas that prevent effective treatment and recovery.",
        },
        {
          videoId: "_OO9w5bXJIU",
          title: "Addiction & Health Equity",
          description:
            "Why understanding the root causes of addiction is essential for achieving health equity.",
        },
      ] satisfies Video[],
      researchPapers: [
        {
          ...
          authors:
            "National Academies of Sciences, Engineering, and Medicine; National Academy of Medicine; Committee on the Future of Nursing 2020–2030; Flaubert JL, Le Menestrel S, Williams DR, et al., editors. ",
          year: "2023",
          description:
        ...
        },
        {
          ...
          year: "2024",
          description:
            "Health equity is a concept that has gained increasing attention and relevance in the context of the COVID-19 pandemic, which has exposed and exacerbated the health disparities and inequities among different population groups in the United States. ",
        ...
        },
        {
          ...
          year: "2021",
          description:
            "The evolution of Healthy People reflects growing awareness of health inequities over the life course. Each decade, the initiative has gained understanding of how the nation can achieve health and well-being. ",
        ...
        },
        {
          ...
          year: "2022",
          description:
            "The term 'health equity' has become widely used in health and health care arenas over the past few years.",
    ...
    items: [
      {
        ...
        description:
          "Educational module from our first general body meeting covering the fundamentals of health equity",
      ...
      },
      {
        ...
        description:
          "Educational module from our second general body meeting on stigmas in healthcare and health equity",
        type: "module" as const,
        date: "2025-10-09",
      ...
      },
      {
        ...
        description:
          "Educational module exploring the impact of socioeconomic status on health outcomes.",
        type: "module" as const,
        date: "2025-10-16",
      ...
      },
      {
        ...
        description:
          "Analyzing how geographic location and built environments influence community health.",
        type: "module" as const,
        date: "2025-10-23",
      ...
      },
      {
        ...
        title:
          "Addiction & Health Equity – Why Recovery Starts with Understanding",
        description:
          "Why understanding the root causes of addiction is essential for achieving health equity.",
        type: "video" as const,
        date: "2025-11-05",
      ...
      },
      {
        ...
        description:
          "National Health Equity Week 2025 Keynote addressing addiction, mental health, and the journey to recovery.",
        type: "video" as const,
        date: "2025-10-01",
      ...
      },
      {
        id: "panel-addiction",
        title:
          "National Health Equity Week 2025: Addiction and Health Equity Speaker Panel",
        description:
          "Expert panel discussion on the intersection of addiction and health equity.",
        type: "video" as const,
        date: "2025-10-02",
      ...
      },
      {
        ...
        description:
          "How a 1930s housing policy still shapes cardiovascular risk. This article explores how HOLC redlining maps created disinvestment patterns that persist today \u2014 leading to urban heat islands, air pollution exposure, and worse cardiovascular outcomes in formerly redlined neighborhoods.",
